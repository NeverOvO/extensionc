                  ...
                  itemBuilder: (context,index){
                    return GestureDetector(
                      ...
                      child: Container(
                        ...
                        child: Row(
                          children: [
                            selectIndex == index ? const Image(image: AssetImage("assets/images/netword_done.png"),width: 16,height: 16,) : const SizedBox(width: 16,height: 16,),
                            Expanded(
                              child: InkWell(
                                onTap:(){
                                  ...
                                  children: [
                                    ...
                                    Expanded(
                                      child: Container(
                                        ...
                                        child: Text("${_walletList![index].name!}\n${_walletList![index].address!}",style: const TextStyle(fontSize: 14,color: Colors.white),),
                                      ),
                                    ),
                                    Container(
                                      alignment: Alignment.centerLeft,
                                      padding: const EdgeInsets.fromLTRB(10, 0, 0, 0),
                                      child: const Text("\$0.00",style: TextStyle(fontSize: 14,color: Colors.white),),
                                    ),
                                  ],
                                ),
                              ),
                            ...
                            InkWell(
                              ...
                              child: Container(
                                ...
                                child: const Image(image: AssetImage("assets/images/edit.png"),height: 13,width: 13,),
                              ),
                            ),
                          ],
                        ),
              ...
              InkWell(
                ...
                child: Container(
                  ...
                  child: Container(
                    ...
                    height: 48,
                    alignment: Alignment.center,
                    child: Text(S.current.Add_Wallet, style: const TextStyle(color: Colors.white, fontSize: 16,),
                    ),
                  ),
                ),
              ),
