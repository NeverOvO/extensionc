          ...
          Container(
            ...
            child: Row(
              children: [
                ...
                const Text(" / 2",style: TextStyle(fontSize: 16,fontWeight: FontWeight.w600,color: APP_MainTextGrayColor),),
              ],
            ),
          ),
          TextField(
    ...
    return Container(
      ...
      child: Column(
        ...
        children: [
          ...
          Text(S.current.password_tip_2, style: TextStyle(color: isError ? Colors.red : APP_MainTextGrayColor, fontSize: 12),),
