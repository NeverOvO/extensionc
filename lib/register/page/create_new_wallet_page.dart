      ...
      child: Column(
        ...
        children: [
            ...
            child: Row(
              children: [
                Expanded(
                  child: Container(
                    alignment: Alignment.centerLeft,
                    child: Text(S.current.Setup_Password,style: const TextStyle(fontSize: 19,fontWeight: FontWeight.w600,color: Colors.white),),
                  )
                ),
                Text(toDoStep.toString(),style: const TextStyle(fontSize: 16,fontWeight: FontWeight.w600,color: APP_MainPurpleColor),),
                const Text(" / 4",style: TextStyle(fontSize: 16,fontWeight: FontWeight.w600,color: APP_MainTextGrayColor),),
              ],
            ),
          ),
          SizedBox(
            ...
            child: TextField(
              ...
              decoration: InputDecoration(
                ...
                suffixIcon: GestureDetector(
                  ...
                  child: Icon(canPasswordSee ? Icons.visibility_sharp : Icons.visibility_off_sharp , color: Colors.white,size: 14,),
                ),
          ...
          Padding(
            ...
            child: Text(S.current.password_tip_1, style: TextStyle(color: isError ? Colors.red : APP_MainTextGrayColor, fontSize: 11),),
          ),
          SizedBox(
            height: 48,
            child: TextField(
          ...
          Padding(
            padding: const EdgeInsets.fromLTRB(0, 8, 0, 8),
            child: Text(S.current.password_tip_2, style: TextStyle(color: isError ? Colors.red : APP_MainTextGrayColor, fontSize: 11),),
          ),
            ...
            child: Row(
              children: [
                Expanded(
                    child: Container(
                      alignment: Alignment.centerLeft,
                      child: Text(S.current.keep_your_mnemonic,style: const TextStyle(fontSize: 19,fontWeight: FontWeight.w600,color: Colors.white),),
                    )
                ),
                Text(toDoStep.toString(),style: const TextStyle(fontSize: 16,fontWeight: FontWeight.w600,color: APP_MainPurpleColor),),
                const Text(" / 4",style: TextStyle(fontSize: 16,fontWeight: FontWeight.w600,color: APP_MainTextGrayColor),),
          ...
          GestureDetector(
            ...
            child:Row(
              children: [
                ...
                Text(S.current.Backed_Up_The_Memo, style: const TextStyle(color: Color(0xFF9E9E9E)),
                ),
              ],
            ),
          ),
      ...
      child: Column(
        ...
        children: [
            ...
            child: Row(
              children: [
                Expanded(
                    child: Container(
                      alignment: Alignment.centerLeft,
                      child: Text(S.current.Verify_Mnemonic_Phrase,style: const TextStyle(fontSize: 19,fontWeight: FontWeight.w600,color: Colors.white),),
                    )
                ),
                Text(toDoStep.toString(),style: const TextStyle(fontSize: 16,fontWeight: FontWeight.w600,color: APP_MainPurpleColor),),
                const Text(" / 4",style: TextStyle(fontSize: 16,fontWeight: FontWeight.w600,color: APP_MainTextGrayColor),),
          ...
          Container(
            alignment: Alignment.centerLeft,
            padding: const EdgeInsets.fromLTRB(0, 0, 0, 20),
            child: Text(S.current.Verify_Mnemonic_Phrase_Tip,style: const TextStyle(fontSize: 12,color: APP_MainTextGrayColor,height: 1),),
          ),
          SizedBox(
            height: 48,
            child: TextField(
    ...
    return Container(
      ...
      child: Column(
        ...
        children: [
          Container(
            alignment: Alignment.center,
            child: const ImageHelper('/images/register_done.png',height: 140,width: 140,),
          ),
          Container(
            alignment: Alignment.center,
            padding: const EdgeInsets.fromLTRB(20, 30, 20, 20),
            child: Text(S.current.Create_Wallet_Successfully,
          ...
          InkWell(
            ...
            child: Container(
              ...
              alignment: Alignment.center,
              child: const Text('Get Started', style: TextStyle(color: Colors.white, fontWeight: FontWeight.w700, fontSize: 14,),
              ),
            ),
          ),
        ],
