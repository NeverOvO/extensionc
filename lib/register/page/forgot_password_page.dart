      ...
      child: Column(
        ...
        children: [
          ...
          InkWell(
            onTap: () async {
              if(!stepOneCheck){
                showMyCustomText(S.current.Forgot_Password_Tip2);
                return;
              }
      ...
      child: Column(
        ...
        children: [
          Container(
            ...
            child: Container(
              alignment: Alignment.centerLeft,
              child: Text(S.current.Retrieve_password,style: const TextStyle(fontSize: 19,fontWeight: FontWeight.w600,color: Colors.white),),
            ),
          ),
          TextField(
          ...
          InkWell(
            ...
            child: Container(
              ...
              child: Container(
                  ...
                  height: 48,
                  alignment: Alignment.center,
                  child: Text(canTouch ? S.current.Get_Password : _sendMessageTitle, style: const TextStyle(color: Colors.white, fontSize: 16,),
                  )
              ),
            ),
          ),
      ...
      child: Column(
        ...
        children: [
          ...
          Container(
            ...
            child: Text(S.current.Forgot_Password_Tip4,
          ...
          InkWell(
            ...
            child: Container(
              ...
              alignment: Alignment.center,
              child: Text(S.current.Wallet_Login, style: const TextStyle(color: Colors.white, fontWeight: FontWeight.w700, fontSize: 14,),
              ),
            ),
          ),
        ],
