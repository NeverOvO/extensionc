              ...
              children: [
                ...
                Container(
                    ...
                    child: Column(
                      ...
                      children: [
                        Text(nftName!,style: const TextStyle(fontSize: 20,color: Colors.white,fontWeight: FontWeight.w700),),
                        const SizedBox(height: 10,),
                        Text(_nftData!["description"],style: const TextStyle(fontSize: 11,color: Colors.white,fontWeight: FontWeight.w700),),
                      ],
                    ),
                ),
                Container(
                  ...
                  alignment: Alignment.centerLeft,
                  child: Text(S.current.Current_price,style: const TextStyle(fontSize: 12,color: Colors.white),),
                ),
                Container(
                  ...
                  child: Row(
                    children: [
                      ClipRRect(
                        ...
                        child: Image(image: NetworkImage(_nftData!["url"]), fit: BoxFit.cover,width: 37,height: 37,
                          errorBuilder: (BuildContext context, Object exception, StackTrace? stackTrace) {
                            return Container(
                              width: 37,
                              height: 37,
                      ...
                      Column(
                        ...
                        children: [
                          Container(
                            ...
                            alignment: Alignment.centerLeft,
                            child: const Text("@KK",style: TextStyle(fontSize: 12,color: Colors.blueAccent),),
                          ),
                          Container(
                            padding: const EdgeInsets.fromLTRB(5, 3, 20, 0),
                            alignment: Alignment.centerLeft,
                            child: Text(S.current.Creator,style: const TextStyle(fontSize: 12,color: Colors.white),),
                          ),
                        ],
                      )
                    ],
            ...
            InkWell(
              ...
              child: Container(
                ...
                child: Container(
                    height: 48,
                    alignment: Alignment.center,
                    child: Text(S.current.Transfer, style: const TextStyle(color: Colors.white, fontSize: 16,),
                    )
                ),
              ),
            ),
