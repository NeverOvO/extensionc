            ...
            children: [
                          ...
                          children: [
                            Container(
                              ...
                              child: Row(
                                ...
                                children: [
                                  Text(S.current.Select_transfer_network, style: const TextStyle(color: Colors.white, fontSize: 13),),
                                  GestureDetector(
                                    onTap: () {
                  ...
                  child: Row(
                    ...
                    children: [
                      Expanded(
                        child: Row(
                          children: [
                            ImageHelper('/icons/crypto/$coin.png', width: 30, height: 30,),
                            const SizedBox(width: 13),
                            Text(coin, style: const TextStyle(color: Colors.white, fontSize: 13),),
                          ],
                        ),
                      ),
                      Text('Standard: $coin', style: const TextStyle(color: Colors.white, fontSize: 13),),
              ...
              Container(
                ...
                child: Column(
                  ...
                  children: [
                    Text(S.current.Address, style: const TextStyle(color: Colors.white, fontSize: 16),),
                          ...
                          suffixIcon: SizedBox(
                            ...
                            child:  GestureDetector(
                              ...
                              child: Container(
                                  ...
                                  child: const Text('MAX', style: TextStyle(color: Colors.white, fontWeight: FontWeight.w500,),
                                  )
                              ),
                            ),
                          ),
             ...
             Container(
               ...
               child:  Row(
                 children: [
                   ...
                   Text((NumUtil.getNumByValueDouble(neverDoubleTryOrZero(suiWallet.suiBalance.toString()) / 1000000000, 9)).toString() + coin, style: const TextStyle(color: APP_MainBgViewColor, fontSize: 12)),
                 ],
               )
             ),
              Container(
                ...
                child: Row(
                  mainAxisAlignment: MainAxisAlignment.spaceBetween,
                  children: [
                    const Text('Fee', style: TextStyle(color: Colors.grey, fontSize: 11),),
                            ...
                            children: [
                              Container(
                                ...
                                child: Row(
                                  ...
                                  MainAxisAlignment.spaceBetween,
                                  children: [
                                    Text(S.current.Please_enter_transaction_password, style: const TextStyle(color: Colors.white, fontSize: 13),),
                                    GestureDetector(
                                      onTap: () {
                                        Navigator.of(context).pop();
                                      },
                              ...
                              Container(
                                ...
                                child: ElevatedButton(
                                  ...
                                  child: Text(S.current.Send, style: const TextStyle(color: Colors.white, fontWeight: FontWeight.w700, fontSize: 18,),
                                  ),
                                ),
                              )
                            ],
